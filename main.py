  ...
  if(preMove == "Rock"):
    ...
    if(eqaulVal == 1):
      ...
      if(randomChoice == 1):
        ...
        print(colored("<There is an error, please make sure you dont mess with values>","red"))
        time.sleep(3)
        quit()
...
while True:
  ...
  if(mainMenuChoice == "1"):
    ...
    print("\033c")
    time_print(colored("This is a Machine Learning Bot that learns the patterns of your moves and uses them to its advantage.","cyan"))
    time.sleep(3)
    skip()
...
while True:
  ...
  if(cpuScore == 15):
    print("\033c")
    time.sleep(.5)
    print(colored("Oh no! Looks like the Machine Learning Bot beat you!","red"))
    time.sleep(.5)
    acessAIDCS()
    break
  elif(playerScore == 15):
    print("\033c")
    time.sleep(.5)
    print(colored("Wow! It looks like you just beat the Machine Learning Bot!","green"))
    time.sleep(.5)
    acessAIDCS()
    break